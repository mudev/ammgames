(function (window){
    ...
    function HeySquirrels() {
        // this.Container_constructor();
        this.initialize();
    }

    var p = HeySquirrels.prototype;
    //var p = createjs.extend(HeySquirrels, createjs.Container);
    ...
    p.gameStateGame = function () {
        var scene = new game.SameSquirrel();
    ...
    window.game.HeySquirrels = HeySquirrels;
    //window.HeySquirrels = createjs.promote(HeySquirrels, 'Container');
